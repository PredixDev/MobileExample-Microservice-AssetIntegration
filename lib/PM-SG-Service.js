...
/*function testOAuthTokenNew() {
    return new Promise(function(resolve, reject) {
        ...
        setTimeout(function() {
            ...
            logger.trace({
                COUNTER: COUNTER
            }, "Running PM authorization sequence now... ");
            var _username = USERNAME;
            var _password = PASSWORD;

            if (!_username) {
                logger.error("Username argument not specified.");
                return;
            }
            if (!_password) {
                logger.error("Password argument not specified.");
                return;
            }
            ...
            return uaaInstance.GetLoginPromptsAndSaveUAAServerURL()
                .then(function(prompts) {
                    ...
                    return uaaInstance.Authenticate({
                            "username": _username,
                            "password": _password
                        })
